...
public class Expenses extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtExpenseName = new RSMaterialComponent.RSTextFieldMaterial();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel1.setBackground(new java.awt.Color(102, 255, 51));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2), "Expenses", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24))); // NOI18N
        ...
        txtExpenseName.setForeground(new java.awt.Color(255, 255, 255));
        txtExpenseName.setPlaceholder("Expense Name");
        jPanel2.add(txtExpenseName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 130, 200, 30));
    ...
    private void rSButtonIconTwo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonIconTwo1ActionPerformed
          co.search("SELECT exp_no, exp_name from expenses where exp_no = '"+txtser.getText()+"'");
       try{
           if(co.rs.next()){
               id = co.rs.getString("exp_no");
               txtExpenseName.setText(co.rs.getString("exp_name"));
           }
      else
           {
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        String oper = "insert";
        String sql = "call expenses_pro('"+txtExpenseName.getText()+"', '"+oper+"',null)";
        co.setSql(sql);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        String oper = "update";
        String sql = "call expenses_pro('"+txtExpenseName.getText()+"', '"+oper+"', '"+id+"')";
        co.setSql(sql);
    ...
    private RSMaterialComponent.RSTextFieldMaterial txtExpenseName;
