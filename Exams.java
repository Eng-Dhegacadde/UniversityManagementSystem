...
public class Exams extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        examtxt = new RSMaterialComponent.RSTextFieldMaterial();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2), "Exams", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24))); // NOI18N
        ...
        rSButtonMaterialIconOne29.setBackground(new java.awt.Color(0, 0, 204));
        rSButtonMaterialIconOne29.setText("Save");
        rSButtonMaterialIconOne29.setBackgroundHover(new java.awt.Color(102, 255, 51));
        ...
        rSButtonMaterialIconOne30.setBackground(new java.awt.Color(0, 0, 204));
        rSButtonMaterialIconOne30.setText("Update");
        rSButtonMaterialIconOne30.setBackgroundHover(new java.awt.Color(102, 255, 51));
        ...
        rSButtonMaterialIconOne31.setBackground(new java.awt.Color(0, 0, 204));
        rSButtonMaterialIconOne31.setText("Delete");
        rSButtonMaterialIconOne31.setBackgroundHover(new java.awt.Color(102, 255, 51));
        ...
        rSButtonMaterialIconOne32.setBackground(new java.awt.Color(0, 0, 204));
        rSButtonMaterialIconOne32.setText("Clear");
        rSButtonMaterialIconOne32.setBackgroundHover(new java.awt.Color(102, 255, 51));
        ...
        examtxt.setForeground(new java.awt.Color(0, 0, 0));
        examtxt.setPhColor(new java.awt.Color(0, 0, 0));
        examtxt.setPlaceholder("Exam Name");
        jPanel2.add(examtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 112, 240, 30));
    ...
    private void rSButtonMaterialIconOne29ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne29ActionPerformed
        String oper = "insert";
        String sql = "call exams_pro('"+examtxt.getText()+"', '"+oper+"', null)";
        co.setSql(sql);
    ...
    private void rSButtonMaterialIconOne30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne30ActionPerformed
        String oper = "update";
        String sql = "call exams_pro('"+examtxt.getText()+"', '"+oper+"', '"+id+"')";
        co.setSql(sql);
    ...
    private void rSButtonIconTwo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonIconTwo1ActionPerformed
        co.search("SELECT exm_no, exm_name from exams where exm_no = '"+txtser.getText()+"'");
        try{
            if(co.rs.next()){
                id = co.rs.getString("exm_no");
                examtxt.setText(co.rs.getString("exm_name"));
            }
      else
           {
    ...
    private RSMaterialComponent.RSTextFieldMaterial examtxt;
