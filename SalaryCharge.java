...
public class SalaryCharge extends javax.swing.JFrame {
    Codes co = new Codes();
    String staf,id;
    public SalaryCharge() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2), "Slary Charge", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24))); // NOI18N
        ...
        jPanel2.add(txtdes, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 322, 230, 30));

        jLabel6.setFont(new java.awt.Font("Tw Cen MT", 1, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Date:");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 70, -1));
        jPanel2.add(ExpDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 220, 30));
        ...
        jPanel2.add(staffCom, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 220, 30));
        ...
        jPanel2.add(txtAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 172, 220, 30));
    ...
    private void rSButtonMaterialIconOne2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne2ActionPerformed
        ...
        String oper = "insert";
        String sql = " call salary_charge_pro('"+staf+"', '"+txtAmount.getText() +"', '"+d1+"','"+txtdes.getText()+"','"+oper+"', null)";
        co.setSql(sql);
//        
    ...
    private void rSButtonIconTwo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonIconTwo1ActionPerformed
        co.search("SELECT sal_no, concat(s.st_no, ',', name) stf, amount,sal_date,description from staff s JOIN salary_charge sc on s.st_no = sc.st_no and sal_no ='"+txtser.getText()+"'");
        try{
            if(co.rs.next()){
                  id = co.rs.getString("sal_no");
    ...
    private void rSButtonMaterialIconOne3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne3ActionPerformed
         Date d1 = new Date(ExpDate.getDate().getTime());
        String oper = "update";
        String sql = "call salary_charge_pro('"+staf+"', '"+txtAmount.getText() +"','"+d1+"','"+txtdes.getText()+"', '"+oper+"','"+id+"')";
        co.setSql(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalaryCharge.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalaryCharge().setVisible(true);
            }
        });
    }
