...
import university.*;
public class Periods extends javax.swing.JFrame {
    Codes co = new Codes();
    String id;
    public Periods() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtPeriodName = new RSMaterialComponent.RSTextFieldMaterial();
        ...
        clear.setText("Clear");
        clear.setBackgroundHover(new java.awt.Color(255, 255, 0));
        clear.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.CLEAR);
        jPanel2.add(clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, 80, -1));

        save.setBackground(new java.awt.Color(51, 0, 51));
        save.setText("Save");
        save.setBackgroundHover(new java.awt.Color(255, 255, 0));
        ...
        jPanel2.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 80, -1));

        update.setBackground(new java.awt.Color(51, 0, 51));
        update.setText("Update");
        update.setBackgroundHover(new java.awt.Color(255, 255, 0));
        ...
        jPanel2.add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 260, 90, -1));

        delete.setBackground(new java.awt.Color(51, 0, 51));
        delete.setText("Delete");
        delete.setBackgroundHover(new java.awt.Color(255, 255, 0));
        ...
        jPanel2.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 260, 90, -1));
        ...
        jPanel2.add(txtser, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, 190, 40));

        txtPeriodName.setBackground(new java.awt.Color(51, 0, 51));
        txtPeriodName.setForeground(new java.awt.Color(255, 255, 255));
        txtPeriodName.setPlaceholder("Period Name");
        jPanel2.add(txtPeriodName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 200, 40));
    ...
    private void rSButtonIconTwo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonIconTwo1ActionPerformed
          co.search("SELECT per_no, period_name from period where per_no  = '"+txtser.getText()+"'");
       try{
           if(co.rs.next()){
               id = co.rs.getString("at_no");
               txtPeriodName.setText(co.rs.getString("amount_name"));
           }
     else
           {
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        String oper = "insert";
        String sql = "call period_pro('"+txtPeriodName.getText()+"', '"+oper+"',null)";
        co.setSql(sql);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        String oper = "update";
        String sql = "call period_pro('"+txtPeriodName.getText()+"', '"+oper+"', '"+id+"')";
        co.setSql(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Periods.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private RSMaterialComponent.RSTextFieldMaterial txtPeriodName;
