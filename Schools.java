...
public class Schools extends javax.swing.JFrame {
    ...
    public Schools() {
        ...
        co.fillComboBox(addCom, "select concat(a.add_no, ',', district) as degmo from address a", "degmo");
    }
    ...
    private void initComponents() {
        ...
        schoolName = new RSMaterialComponent.RSTextFieldMaterial();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2), "Schools", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 24))); // NOI18N
        ...
        rSButtonMaterialIconOne29.setBackgroundHover(new java.awt.Color(22, 219, 101));
        ...
        rSButtonMaterialIconOne30.setBackgroundHover(new java.awt.Color(22, 219, 101));
        ...
        rSButtonMaterialIconOne31.setBackgroundHover(new java.awt.Color(22, 219, 101));
        ...
        rSButtonMaterialIconOne32.setBackgroundHover(new java.awt.Color(22, 219, 101));
        ...
        schoolName.setPhColor(new java.awt.Color(0, 0, 0));
        schoolName.setPlaceholder("School Name");
        jPanel2.add(schoolName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 112, 240, 30));
        ...
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 150, -1));
        ...
        jPanel2.add(addCom, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 170, 240, 30));
    ...
    private void rSButtonMaterialIconOne29ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne29ActionPerformed
        String oper = "insert";
        String sql = "call schools_pro('"+schoolName.getText()+"', '"+add+"','"+oper+"', null)";
        co.setSql(sql);
    ...
    private void rSButtonMaterialIconOne30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne30ActionPerformed
        String oper = "update";
        String sql = "call schools_pro('"+schoolName.getText()+"', '"+add+"','"+oper+"', '"+id+"')";
        co.setSql(sql);
    ...
    private void rSButtonIconTwo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonIconTwo1ActionPerformed
        ...
        co.search(" SELECT sh_no, school_Name, concat(a.add_no, ',', district) as degmo from address a, schools s  where a.add_no = s.add_no and sh_no ='"+txtser.getText()+"'");
        try{
            if(co.rs.next()){
                id = co.rs.getString("sh_no");
                schoolName.setText(co.rs.getString("school_Name"));
                addCom.setSelectedItem(co.rs.getString("degmo"));
            }
       else
           {
    ...
    private RSMaterialComponent.RSTextFieldMaterial schoolName;
